...
4. Inspect actual artifacts and evidence. Use independent review for consequential work, always for high-risk work. After integration, review the combined diff and validate the final revision. A worker's confidence, an open PR, or tests from an older revision do not establish completion.
